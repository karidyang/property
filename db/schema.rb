...
ActiveRecord::Schema.define(:version => 20131020115903) do
  ...
  create_table "car_ports", :force => true do |t|
    t.string   "port_no"
  ...
  add_index "notices_users", ["notice_id", "user_id"], :name => "index_notices_users_on_notice_id_and_user_id", :unique => true
